var chat =  app.controller('ChatController', function ($stateParams,$sanitize,$ionicScrollDelegate,$timeout) {
	var self = this;
	var typing = false; 
	var lastTypingTime;
	...
	socket.on('connect', function(){
		...
		//whenever socket emits typing event show typing message
		socket.on('typing', function(data){
			addChatTyping(data);
		});

		//when server emits stop typing, kill typing message
		socket.on('stop typing', function(data){
			removeChatTyping(data.username);
		});

		//adds visual typing message
